...
Example:
    ...
    from {{cookiecutter.module_name}}.dependencies import SessionDep, RBACDep
...
from {{cookiecutter.module_name}}.managers.keycloak_manager import (
    KeycloakManager,
)
...
# Note: Project-specific repository dependencies (e.g., AuthorRepoDep) should
# be added here as needed. Example:
#
# def get_author_repository(session: SessionDep) -> Any:
#     from {{cookiecutter.module_name}}.repositories.author_repository import AuthorRepository
