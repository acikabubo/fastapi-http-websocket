...
see {{cookiecutter.module_name}}/settings.py where values can be overridden via environment variables.
"""
...
# For default page size, see {{cookiecutter.module_name}}/settings.py (DEFAULT_PAGE_SIZE)
MAX_PAGE_SIZE = 1000
