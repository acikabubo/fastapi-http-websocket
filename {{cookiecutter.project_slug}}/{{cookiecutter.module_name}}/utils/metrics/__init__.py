...
imports continue to work:
    ...
    from {{cookiecutter.module_name}}.utils.metrics import http_requests_total
    from {{cookiecutter.module_name}}.utils.metrics import ws_connections_active
    from {{cookiecutter.module_name}}.utils.metrics import db_query_duration_seconds
"""
...
from {{cookiecutter.module_name}}.utils.metrics.audit import (
    audit_batch_size,
...
from {{cookiecutter.module_name}}.utils.metrics.auth import (
    auth_attempts_total,
...
from {{cookiecutter.module_name}}.utils.metrics.database import (
    db_connections_active,
    db_query_duration_seconds,
    db_query_errors_total,
    db_slow_queries_total,
)
from {{cookiecutter.module_name}}.utils.metrics.http import (
    http_request_duration_seconds,
    http_requests_in_progress,
    http_requests_total,
)
from {{cookiecutter.module_name}}.utils.metrics.redis import (
...
from {{cookiecutter.module_name}}.utils.metrics.websocket import (
