...
from {{cookiecutter.module_name}}.schemas.author import AuthorQueryParams
from {{cookiecutter.module_name}}.schemas.response import PaginatedResponseModel
from {{cookiecutter.module_name}}.settings import app_settings
from {{cookiecutter.module_name}}.storage.db import async_session, get_paginated_results
