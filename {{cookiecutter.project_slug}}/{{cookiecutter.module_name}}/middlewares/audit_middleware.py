...
from {{cookiecutter.module_name}}.types import AuditOutcome, RequestId, UserId, Username
from {{cookiecutter.module_name}}.utils.audit_logger import extract_ip_address, log_user_action
