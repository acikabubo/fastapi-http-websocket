...
def app():
    ...
    """
    from {{cookiecutter.module_name}}.api.http.health import router
...
async def test_health_endpoint_all_services_healthy(client):
    ...
    with (
        patch("{{cookiecutter.module_name}}.api.http.health.engine", mock_engine),
        patch(
            "{{cookiecutter.module_name}}.api.http.health.get_redis_connection",
            return_value=mock_redis,
        ),
        patch(
            "{{cookiecutter.module_name}}.api.http.health.get_websocket_health_info",
