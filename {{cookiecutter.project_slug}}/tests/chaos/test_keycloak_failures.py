...
class TestKeycloakConnectionFailures:
    ...
    async def test_keycloak_server_unavailable(self):
        ...
        with patch("{{cookiecutter.module_name}}.managers.keycloak_manager.KeycloakOpenID") as mock_kc:
            mock_openid = Mock()
...
class TestKeycloakConfigurationErrors:
    ...
    def test_invalid_realm_configuration(self):
        ...
        with patch(
            "{{cookiecutter.module_name}}.managers.keycloak_manager.KeycloakOpenID",
