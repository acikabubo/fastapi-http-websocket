...
- **Authorization**: Fine-grained RBAC with decorator-based permissions
...
- **Database**: PostgreSQL with async SQLModel/SQLAlchemy and Alembic migrations
...
**Built with**: FastAPI, PostgreSQL, Redis, Keycloak, Prometheus, Grafana, Loki, and modern Python tooling
