...
from app.utils.ip_utils import get_client_ip, is_trusted_proxy
...
class TestIsTrustedProxy:
    ...
    def test_empty_trusted_proxies_list(self):
        ...
        with patch("app.utils.ip_utils.app_settings") as mock_settings:
    ...
    def test_invalid_proxy_in_list(self):
        ...
        with (
            patch("app.utils.ip_utils.app_settings") as mock_settings,
            patch("app.utils.ip_utils.logger") as mock_logger,
        ):
            mock_settings.TRUSTED_PROXIES = [
                "192.168.1.0/24",
                "invalid-proxy",
