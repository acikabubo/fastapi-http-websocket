...
@redis_safe(
    fail_value=None, log_level="error", operation_name="get_cached_count"
)
...
@redis_safe(
    fail_value=None, log_level="error", operation_name="set_cached_count"
)
...
@redis_safe(
    fail_value=None, log_level="error", operation_name="invalidate_count_cache"
)
